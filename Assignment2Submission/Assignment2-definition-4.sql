...
UNIQUE(name), 
PRIMARY KEY (id), 
FOREIGN KEY (cid) REFERENCES client(id) ON UPDATE CASCADE 
)ENGINE=InnoDB;
...
INSERT INTO client (first_name, last_name, dob) VALUES ("Sara", "Smith", "1970-01-02"), ("David", "Atkins", "1979-11-18"), ("Daniel", "Jensen", "1985-03-02"); 
...
((SELECT id FROM employee WHERE first_name = 'Michael' AND last_name = 'Fern'), (SELECT id FROM project WHERE name = 'Eclipse'), "2013-08-08"), 
((SELECT id FROM employee WHERE first_name = 'Michael' AND last_name = 'Fern'), (SELECT id FROM project WHERE name = 'Moon'), "2014-09-11"); 
